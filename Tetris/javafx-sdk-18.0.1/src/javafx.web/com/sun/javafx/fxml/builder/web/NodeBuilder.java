...
public abstract class NodeBuilder<B extends NodeBuilder<B>> {
    ...
    public void applyTo(javafx.scene.Node x) {
        ...
        for (int i = -1; (i = set.nextSetBit(i + 1)) >= 0; ) {
            switch (i) {
                case 0:
                    x.setBlendMode(this.blendMode);
                    break;
                case 1:
                    x.setCache(this.cache);
                    break;
                case 2:
                    x.setCacheHint(this.cacheHint);
                    break;
                case 3:
                    x.setClip(this.clip);
                    break;
                case 4:
                    x.setCursor(this.cursor);
                    break;
                case 5:
                    x.setDepthTest(this.depthTest);
                    break;
                case 6:
                    x.setDisable(this.disable);
                    break;
                case 7:
                    x.setEffect(this.effect);
                    break;
                case 8:
                    x.setEventDispatcher(this.eventDispatcher);
                    break;
                case 9:
                    x.setFocusTraversable(this.focusTraversable);
                    break;
                case 10:
                    x.setId(this.id);
                    break;
                case 11:
                    x.setInputMethodRequests(this.inputMethodRequests);
                    break;
                case 12:
                    x.setLayoutX(this.layoutX);
                    break;
                case 13:
                    x.setLayoutY(this.layoutY);
                    break;
                case 14:
                    x.setManaged(this.managed);
                    break;
                case 15:
                    x.setMouseTransparent(this.mouseTransparent);
                    break;
                case 16:
                    x.setOnContextMenuRequested(this.onContextMenuRequested);
                    break;
                case 17:
                    x.setOnDragDetected(this.onDragDetected);
                    break;
                case 18:
                    x.setOnDragDone(this.onDragDone);
                    break;
                case 19:
                    x.setOnDragDropped(this.onDragDropped);
                    break;
                case 20:
                    x.setOnDragEntered(this.onDragEntered);
                    break;
                case 21:
                    x.setOnDragExited(this.onDragExited);
                    break;
                case 22:
                    x.setOnDragOver(this.onDragOver);
                    break;
                case 23:
                    x.setOnInputMethodTextChanged(this.onInputMethodTextChanged);
                    break;
                case 24:
                    x.setOnKeyPressed(this.onKeyPressed);
                    break;
                case 25:
                    x.setOnKeyReleased(this.onKeyReleased);
                    break;
                case 26:
                    x.setOnKeyTyped(this.onKeyTyped);
                    break;
                case 27:
                    x.setOnMouseClicked(this.onMouseClicked);
                    break;
                case 28:
                    x.setOnMouseDragEntered(this.onMouseDragEntered);
                    break;
                case 29:
                    x.setOnMouseDragExited(this.onMouseDragExited);
                    break;
                case 30:
                    x.setOnMouseDragged(this.onMouseDragged);
                    break;
                case 31:
                    x.setOnMouseDragOver(this.onMouseDragOver);
                    break;
                case 32:
                    x.setOnMouseDragReleased(this.onMouseDragReleased);
                    break;
                case 33:
                    x.setOnMouseEntered(this.onMouseEntered);
                    break;
                case 34:
                    x.setOnMouseExited(this.onMouseExited);
                    break;
                case 35:
                    x.setOnMouseMoved(this.onMouseMoved);
                    break;
                case 36:
                    x.setOnMousePressed(this.onMousePressed);
                    break;
                case 37:
                    x.setOnMouseReleased(this.onMouseReleased);
                    break;
                case 38:
                    x.setOnRotate(this.onRotate);
                    break;
                case 39:
                    x.setOnRotationFinished(this.onRotationFinished);
                    break;
                case 40:
                    x.setOnRotationStarted(this.onRotationStarted);
                    break;
                case 41:
                    x.setOnScroll(this.onScroll);
                    break;
                case 42:
                    x.setOnScrollFinished(this.onScrollFinished);
                    break;
                case 43:
                    x.setOnScrollStarted(this.onScrollStarted);
                    break;
                case 44:
                    x.setOnSwipeDown(this.onSwipeDown);
                    break;
                case 45:
                    x.setOnSwipeLeft(this.onSwipeLeft);
                    break;
                case 46:
                    x.setOnSwipeRight(this.onSwipeRight);
                    break;
                case 47:
                    x.setOnSwipeUp(this.onSwipeUp);
                    break;
                case 48:
                    x.setOnTouchMoved(this.onTouchMoved);
                    break;
                case 49:
                    x.setOnTouchPressed(this.onTouchPressed);
                    break;
                case 50:
                    x.setOnTouchReleased(this.onTouchReleased);
                    break;
                case 51:
                    x.setOnTouchStationary(this.onTouchStationary);
                    break;
                case 52:
                    x.setOnZoom(this.onZoom);
                    break;
                case 53:
                    x.setOnZoomFinished(this.onZoomFinished);
                    break;
                case 54:
                    x.setOnZoomStarted(this.onZoomStarted);
                    break;
                case 55:
                    x.setOpacity(this.opacity);
                    break;
                case 56:
                    x.setPickOnBounds(this.pickOnBounds);
                    break;
                case 57:
                    x.setRotate(this.rotate);
                    break;
                case 58:
                    x.setRotationAxis(this.rotationAxis);
                    break;
                case 59:
                    x.setScaleX(this.scaleX);
                    break;
                case 60:
                    x.setScaleY(this.scaleY);
                    break;
                case 61:
                    x.setScaleZ(this.scaleZ);
                    break;
                case 62:
                    x.setStyle(this.style);
                    break;
                case 63:
                    x.getStyleClass().addAll(this.styleClass);
                    break;
                case 64:
                    x.getTransforms().addAll(this.transforms);
                    break;
                case 65:
                    x.setTranslateX(this.translateX);
                    break;
                case 66:
                    x.setTranslateY(this.translateY);
                    break;
                case 67:
                    x.setTranslateZ(this.translateZ);
                    break;
                case 68:
                    x.setUserData(this.userData);
                    break;
                case 69:
                    x.setVisible(this.visible);
                    break;
            }
        }
    }
