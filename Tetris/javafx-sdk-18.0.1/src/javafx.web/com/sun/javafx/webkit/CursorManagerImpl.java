...
public final class CursorManagerImpl extends CursorManager<Cursor> {
    ...
    @Override
    protected Cursor getCustomCursor(WCImage image, int hotspotX, int hotspotY) {
    ...
    @Override
    protected Cursor getPredefinedCursor(int type) {
        switch (type) {
            default:
            case POINTER:
            ...
            case NORTH_EAST_SOUTH_WEST_RESIZE:
                return getCustomCursor("resize.nesw", Cursor.DEFAULT);
            case NORTH_WEST_SOUTH_EAST_RESIZE:
