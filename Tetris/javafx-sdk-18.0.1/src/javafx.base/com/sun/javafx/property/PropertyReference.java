...
public final class PropertyReference<T> {
     ...
     *
     * @param clazz The class of the {@link Bean} that contains the property
     * @param name  The name of the property
     * @throws NullPointerException     if {@code clazz} or {@code name} are null
     * @throws IllegalArgumentException if {@code name} is an empty {@code String}
     */
     ...
     *
     * @param bean  The {@link Bean} instance for which the property should be set
     ...
     *
     * @param bean The {@code Bean} instance for which the property should be
     *             read
     ...
     * @throws IllegalStateException if the property does not provide an implementation
     */
    @SuppressWarnings("unchecked")
