...
public abstract class StringProperty extends ReadOnlyStringProperty implements
     ...
     * @param other     the other {@code Property}
     * @param converter the {@code StringConverter} used to convert between this {@code StringProperty}
     *                  and the other {@code Property}
     * @throws NullPointerException     if {@code other} or {@code converter} is {@code null}
     * @throws IllegalArgumentException if {@code other} is {@code this}
     * @since JavaFX 2.1
     */
