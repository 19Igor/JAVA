...
class GlassViewEventHandler extends View.EventHandler {
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleKeyEvent(View view, long time, int type, int key,
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleMenuEvent(final View view,
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleScrollEvent(final View view, final long time,
                                  final int x, final int y, final int xAbs, final int yAbs,
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleInputMethodEvent(final long time, final String text,
    ...
    @Override
    public int handleDragEnter(View view,
                               final int x, final int y, final int xAbs, final int yAbs,
    ...
    @Override
    public void handleDragLeave(View view, final ClipboardAssistance dropTargetAssistant) {
        if (PULSE_LOGGING_ENABLED) {
    ...
    @Override
    public int handleDragDrop(View view,
                              final int x, final int y, final int xAbs, final int yAbs,
                              final int recommendedDropAction,
                              final ClipboardAssistance dropTargetAssistant) {
        if (PULSE_LOGGING_ENABLED) {
    ...
    @Override
    public int handleDragOver(View view,
                              final int x, final int y, final int xAbs, final int yAbs,
                              final int recommendedDropAction,
                              final ClipboardAssistance dropTargetAssistant) {
        if (PULSE_LOGGING_ENABLED) {
    ...
    @Override
    public void handleDragStart(View view, final int button,
                                final int x, final int y, final int xAbs, final int yAbs,
    ...
    @Override
    public void handleDragEnd(View view, final int performedAction) {
        if (PULSE_LOGGING_ENABLED) {
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleViewEvent(View view, long time, final int type) {
        if (PULSE_LOGGING_ENABLED) {
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleScrollGestureEvent(
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleRotateGestureEvent(
            View view, final long time, final int type,
            final int modifiers, final boolean isDirect, final boolean isInertia,
            final int originx, final int originy,
            final int originxAbs, final int originyAbs,
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleSwipeGestureEvent(
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleBeginTouchEvent(
    ...
    @SuppressWarnings("removal")
    @Override
    public void handleNextTouchEvent(
