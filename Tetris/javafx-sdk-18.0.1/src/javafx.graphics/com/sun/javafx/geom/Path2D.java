...
public class Path2D extends Shape implements PathConsumer2D {
     ...
     * @throws IllegalArgumentException  if the {@code tfrom} and {@code tto} values do not satisfy the
     ...
     * @throws IllegalPathStateException if there is no current point in the path and the prefix is
