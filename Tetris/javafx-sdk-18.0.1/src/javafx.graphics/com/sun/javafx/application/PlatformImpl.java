...
public class PlatformImpl {
    ...
    private static void initDeviceDetailsFXCanvas() {
        ...
        @SuppressWarnings("removal") final long eventProc = AccessController.doPrivileged((PrivilegedAction<Long>) () ->
    ...
    private static void initFXCanvas() {
        ...
        @SuppressWarnings("removal") final StackWalker walker = AccessController.doPrivileged((PrivilegedAction<StackWalker>) () ->
    ...
    private static void runLater(final Runnable r, boolean exiting) {
        ...
        synchronized (runLaterLock) {
            ...
            @SuppressWarnings("removal") final AccessControlContext acc = AccessController.getContext();
...
//                System.err.println("PlatformImpl.tkExit: calling Toolkit.exit");
    ...
    public static boolean isSupported(ConditionalFeature feature) {
        ...
        if (supported && (feature == ConditionalFeature.TRANSPARENT_WINDOW)) {
            ...
            @SuppressWarnings("removal") final SecurityManager securityManager =
    ...
    private static void _setAccessibilityTheme(String platformTheme) {
        ...
        @SuppressWarnings("removal") final String userTheme = AccessController.doPrivileged(
    ...
    private static void _setPlatformUserAgentStylesheet(String stylesheetUrl) {
        ...
        @SuppressWarnings("removal") final String overrideStylesheetUrl = AccessController.doPrivileged(
