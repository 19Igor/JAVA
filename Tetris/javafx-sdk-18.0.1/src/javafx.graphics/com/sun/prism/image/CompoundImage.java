...
public abstract class CompoundImage {
    ...
    public CompoundImage(Image image, int maxSize, int borderSize) {
        ...
        u0 = new int[uSections];
        u1 = new int[uSections];
        v0 = new int[vSections];
        v1 = new int[vSections];
    ...
    private int lBorder(int i) {
        return i > 0 ? uBorderSize : 0;
    }

    private int rBorder(int i) {
        return (i < uSections - 1) ? uBorderSize : 0;
    }

    private int uBorder(int i) {
        return i > 0 ? vBorderSize : 0;
    }

    private int dBorder(int i) {
        return (i < vSections - 1) ? vBorderSize : 0;
    }
