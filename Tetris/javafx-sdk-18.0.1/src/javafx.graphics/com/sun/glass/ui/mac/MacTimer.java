...
final class MacTimer extends Timer {
    ...
    @Override
    native protected long _start(Runnable runnable);

    @Override
    native protected long _start(Runnable runnable, int period);

    @Override
    native protected void _stop(long timer);

    @Override
    native protected void _pause(long timer);

    @Override
    native protected void _resume(long timer);
