...
final class WinPixels extends Pixels {
    ...
    @Override
    native protected void _fillDirectByteBuffer(ByteBuffer bb);

    @Override
    native protected void _attachInt(long ptr, int w, int h, IntBuffer ints, int[] array, int offset);

    @Override
    native protected void _attachByte(long ptr, int w, int h, ByteBuffer bytes, byte[] array, int offset);
}
