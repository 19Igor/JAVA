...
public class CommonDialogs {
    ...
    public final static class ExtensionFilter {
         ...
         * @throws IllegalArgumentException if the description of the filter is {@code null} or empty;
     ...
     * results object.
     * @throws IllegalArgumentException if the initial folder is an invalid folder;
