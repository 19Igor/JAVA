...
//      }
     ...
     * @throws IllegalArgumentException if {@code time} is {@link Duration#UNKNOWN}
     ...
     * @throws NullPointerException  if {@code cuePoint} is {@code null}
     * @throws IllegalStateException if embedded in another animation,
     *                               such as {@link SequentialTransition} or {@link ParallelTransition}
     * @see #getCuePoints()
     */
     ...
     *
     * @param targetFramerate The custom target frame rate for this {@code Animation}
