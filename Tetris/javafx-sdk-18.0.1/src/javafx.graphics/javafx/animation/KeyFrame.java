...
public final class KeyFrame {
     ...
     * be ignored.
     *
     * @param time       the {@code time}
     * @param name       the {@code name}
     * @param onFinished the {@code onFinished}
     * @param values     a {@link javafx.collections.ObservableList} of
     *                   {@link KeyValue} instances
     * @throws NullPointerException     if {@code time} is null
     * @throws IllegalArgumentException if {@code time} is invalid (see {@link #getTime time})
     */
     ...
     * @param name       the {@code name}
     * @param onFinished the {@code onFinished}
     * @param values     the {@link KeyValue} instances
     * @throws NullPointerException     if {@code time} is null
     * @throws IllegalArgumentException if {@code time} is invalid (see {@link #getTime time})
     */
    public KeyFrame(@NamedArg("time") Duration time, @NamedArg("name") String name,
