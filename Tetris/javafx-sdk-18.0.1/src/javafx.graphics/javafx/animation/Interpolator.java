...
public abstract class Interpolator {
     ...
     * according to the function defined in {@link #curve(double) curve()}.
     *
     * @param startValue the first data point
     * @param endValue   the second data point
     * @param fraction   the fraction in {@code [0.0...1.0]}
     ...
     *
     * @param t time, but normalized to the range [0.0..1.0], where 0.0 is the
