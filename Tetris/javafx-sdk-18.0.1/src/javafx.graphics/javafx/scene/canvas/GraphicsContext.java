...
public final class GraphicsContext {
    ...
    private void writeArcType(ArcType closure) {
        ...
        switch (closure) {
            case OPEN:
                type = NGCanvas.ARC_OPEN;
                break;
            case CHORD:
                type = NGCanvas.ARC_CHORD;
                break;
            case ROUND:
                type = NGCanvas.ARC_PIE;
                break;
            default:
                return;  // ignored for consistency with other attributes
        }
...
//          quad test for coverage...?
        ...
        if (cap != null && curState.linecap != cap) {
            ...
            switch (cap) {
                case BUTT:
                    ...
                    break;
                case ROUND:
                    v = NGCanvas.CAP_ROUND;
                    break;
                case SQUARE:
                    v = NGCanvas.CAP_SQUARE;
                    break;
                default:
                    return;
            }
    ...
    public void setLineJoin(StrokeLineJoin join) {
        if (join != null && curState.linejoin != join) {
            ...
            switch (join) {
                case MITER:
                    v = NGCanvas.JOIN_MITER;
                    break;
                case BEVEL:
                    v = NGCanvas.JOIN_BEVEL;
                    break;
                case ROUND:
                    v = NGCanvas.JOIN_ROUND;
                    break;
                default:
                    return;
            }
    ...
    public void setTextAlign(TextAlignment align) {
        if (align != null && curState.textalign != align) {
            ...
            switch (align) {
                case LEFT:
                    a = NGCanvas.ALIGN_LEFT;
                    break;
                case CENTER:
                    a = NGCanvas.ALIGN_CENTER;
                    break;
                case RIGHT:
                    a = NGCanvas.ALIGN_RIGHT;
                    break;
                case JUSTIFY:
                    a = NGCanvas.ALIGN_JUSTIFY;
                    break;
                default:
                    return;
            }
        ...
        if (baseline != null && curState.textbaseline != baseline) {
            ...
            switch (baseline) {
                case TOP:
                    ...
                    break;
                case CENTER:
                    b = NGCanvas.BASE_MIDDLE;
                    break;
                case BASELINE:
                    b = NGCanvas.BASE_ALPHABETIC;
                    break;
                case BOTTOM:
                    b = NGCanvas.BASE_BOTTOM;
                    break;
                default:
                    return;
            }
