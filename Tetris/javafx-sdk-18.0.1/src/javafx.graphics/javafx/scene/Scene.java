        ...
        private MouseEvent preProcess(MouseEvent e) {
            ...
            if (e.getEventType() == MouseEvent.MOUSE_PRESSED) {
                ...
                if (!e.isPrimaryButtonDown()) {
                    counters.get(MouseButton.PRIMARY).clear();
                }
                if (!e.isSecondaryButtonDown()) {
                    counters.get(MouseButton.SECONDARY).clear();
                }
                if (!e.isMiddleButtonDown()) {
                    counters.get(MouseButton.MIDDLE).clear();
                }
    ...
    Accessible getAccessible() {
        ...
        if (accessible == null) {
            ...
            accessible.setEventHandler(new Accessible.EventHandler() {
                ...
                @Override
                public Object getAttribute(AccessibleAttribute attribute,
                                           Object... parameters) {
                    switch (attribute) {
                        case CHILDREN: {
                            Parent root = getRoot();
