...
public class TilePane extends Pane {
    ...
    public final int getPrefRows() {
        return prefRows == null ? 5 : prefRows.get();
    }
    ...
    public final int getPrefColumns() {
        return prefColumns == null ? 5 : prefColumns.get();
    }
    ...
    public final double getPrefTileWidth() {
        return prefTileWidth == null ? USE_COMPUTED_SIZE : prefTileWidth.get();
    }
    ...
    public final double getPrefTileHeight() {
        return prefTileHeight == null ? USE_COMPUTED_SIZE : prefTileHeight.get();
    }
    ...
    public final Pos getTileAlignment() {
        return tileAlignment == null ? Pos.CENTER : tileAlignment.get();
    }
