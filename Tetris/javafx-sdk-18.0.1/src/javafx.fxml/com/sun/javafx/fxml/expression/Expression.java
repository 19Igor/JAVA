...
public abstract class Expression<T> {
     ...
     *
     * @param namespace The namespace against which the expression will be evaluated.
     ...
     *
     * @param namespace The namespace against which the expression will be evaluated.
     * @return <tt>true</tt> if the expression is defined; <tt>false</tt>, otherwise.
     */
     ...
     * assigned to).
     *
     * @return <tt>true</tt> if the expression is an l-value; <tt>false</tt>,
     * otherwise.
     */
     ...
     * @param namespace
     * @param keyPath
     * @return The value at the given path, or <tt>null</tt> if no such value exists.
     */
     ...
     * @param namespace
     * @param key
     * @return The value at the given key, or <tt>null</tt> if no such value exists.
     */
    @SuppressWarnings("unchecked")
     ...
     * @param namespace
     * @param key
     * @return <tt>true</tt> if the key exists; <tt>false</tt>, otherwise.
     */
    @SuppressWarnings("unchecked")
     ...
     * tree.
     *
     * @param value The string representation of the expression.
     */
